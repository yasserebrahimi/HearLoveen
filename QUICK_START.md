...
### مستندات داخلی:
- [RCT Protocol](01-clinical-validation/protocols/rct-protocol.md)
- [Informed Consent](01-clinical-validation/consent-forms/informed-consent.md)
- [Statistical Analysis](01-clinical-validation/statistical-analysis/rct_analysis.py)
- [Business Model Canvas](02-business-model/canvas/business-model-canvas.md)
- [Competitive Analysis](03-competitive-analysis/competitive-matrix.md)
- [Explainable AI API](04-explainable-ai/backend/explainable_api.py)
- [Longitudinal Study](05-longitudinal-study/study-design/longitudinal-protocol.md)
